...
to go
  ; set 3 scenarios of innovation diffusion
  if all? turtles [not infected?]
    [ stop ]
  if count turtles with [infected?] / count turtles * 100 > 74
   [ stop ]
  if ticks = 3000
    [ stop ]
   ask turtles
...
@#$#@#$#@
<experiments>
  <experiment name="virus-spread-chance 0-10" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="virus-check-frequency 0-20" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5000"/>
    <metric>count turtles with [infected?]</metric>
    ...
    <steppedValueSet variable="virus-check-frequency" first="0" step="1" last="20"/>
    <enumeratedValueSet variable="average-node-degree">
      <value value="3"/>
    </enumeratedValueSet>
  ...
  <experiment name="recovery-chance 0 1 10" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5000"/>
    <metric>count turtles with [infected?]</metric>
    ...
    <steppedValueSet variable="recovery-chance" first="0" step="1" last="10"/>
  </experiment>
  <experiment name="gain-resistance-chance 0 5 100" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5000"/>
    <metric>count turtles with [infected?]</metric>
    ...
    <steppedValueSet variable="gain-resistance-chance" first="0" step="5" last="100"/>
    <enumeratedValueSet variable="virus-check-frequency">
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="average-node-degree">
  ...
  <experiment name="number-of-nodes 5 5 300" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5000"/>
    <metric>count turtles with [infected?]</metric>
    <steppedValueSet variable="number-of-nodes" first="5" step="5" last="300"/>
    <enumeratedValueSet variable="average-node-degree">
      <value value="3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-outbreak-size">
  ...
  <experiment name="average-node-degree 1 1 49" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5000"/>
    <metric>count turtles with [infected?]</metric>
    ...
    <steppedValueSet variable="average-node-degree" first="1" step="1" last="49"/>
    <enumeratedValueSet variable="initial-outbreak-size">
      <value value="4"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="gain-resistance-chance">
  ...
  <experiment name="initial-outbreak-size 1 1 50" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5000"/>
    <metric>count turtles with [infected?]</metric>
    ...
    <steppedValueSet variable="initial-outbreak-size" first="1" step="1" last="50"/>
    <enumeratedValueSet variable="gain-resistance-chance">
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="virus-check-frequency">
